...
- e2e 场景契约：`scripts/e2e/cli_scenarios.py`（E1–E19）、`scripts/e2e/web_scenarios.py`（E11/E15/E18b）、`scripts/e2e/config_scenarios.py`（E20，免 key 配置面）
