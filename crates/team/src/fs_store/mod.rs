...
pub use projection::TopicTurnPage;
...
/// Bounded projection for Node inspection; large JSON strings are streamed
/// past without allocating the full topic file.
pub fn load_topic_summary(
    team_root: &Path,
    team_name: &str,
    topic_id: &str,
) -> Result<serde_json::Value> {
    projection::topic_summary(team_root, team_name, topic_id)
}

pub fn load_topic_turns_page(
    team_root: &Path,
    team_name: &str,
    topic_id: &str,
    after_turn: usize,
