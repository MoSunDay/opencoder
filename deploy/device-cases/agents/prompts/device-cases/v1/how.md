...
/opt/device-cases/harness/dependencies/runtime/bin/python3 -B /opt/device-cases/harness/native-harness.py --device-context PRIVATE_PATH run --case-source ORIGINAL_CASE_SOURCE --case-id ORIGINAL_CASE_ID --concurrency 1 --full-evidence --inspect-ui
