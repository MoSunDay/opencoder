...
发布采用该代码基线与业务工具 0.7.0（`62648d893a1f75d0df6bb7dfb37322673db14661`）。Server/Node 协议 7，两个业务 Agent 和 DAG 已登记；原 9 条任务与 5 份报告逐项一致，节点保留 20/FIFO，独立报告文件服务和原凭据保持不变。上线浏览器检查资源版本、profile 绑定与 Runner 列表通过。
